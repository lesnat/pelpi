...
class Beg1997(object):
    ...
    def getHotElectronTemperature(self):
        ...
        return (100.*_u.keV) * (self._lpi.laser.I0.to(_u.W*_u.cm**-2)/(1e17*_u.W*_u.cm**-2) * (self._lpi.laser.wavelength.to(_u.um)/(1*_u.um))**2 )**(1/3.)
...
class Haines2009(object):
    ...
    def getHotElectronTemperature(self):
        ...
        """
        return ((1.0 + 2.0**(1/2.) * self._lpi.laser.a0)**(1/2.) - 1.0) * 511 * _u.keV
...
class Wilks1992(object):
    ...
    def getHotElectronTemperature(self):
        return ((1.0 + self._lpi.laser.a0**2)**(1/2.) - 1.0 )*511 * _u.keV
